...
latex_documents = [
  ('index', 'gocept.jsform.tex', u'gocept.jsform Documentation',
...
man_pages = [
    ('index', 'gocept.jsform', u'gocept.jsform Documentation',
...
texinfo_documents = [
  ('index', 'gocept.jsform', u'gocept.jsform Documentation',
   u'gocept gmbh & co. ks', 'jsform', 'Advanced forms in javascript.',
   'Miscellaneous'),
]
